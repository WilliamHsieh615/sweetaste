...
<body>
    ...
    <div class="wrap">
        ...
        <main class="retrieve_main">

            <form method="post" action="${pageContext.request.contextPath}/retrieve-password">

                <h2>密碼重設</h2>

                <div class="form_input sentVerify_input">
                    <div class="account">
                ...
                <div class="verify">
                    ...
                    <button type="submit" class="verify_button">立即驗證</button>
                </div>

                <div class="form_input retrieve_input">
                    <div class="password">
                        <input type="password" name="password" id="password" class="password_input setPassword"
                            placeholder="請輸入新密碼" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,12}$"
                ...
                <button type="submit" class="retrieve_button">立即重設</button>
